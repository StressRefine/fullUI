...
namespace SRUi
{
    public partial class optionsDlg : Form
    {
        ...
        private void optionsDlg_Load(object sender, EventArgs e)
        {
            ...
            cnvComboBox.SelectedIndex = mainform.stressCnvType;
        }
        ...
        private void cnvComboBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            mainform.stressCnvType = cnvComboBox.SelectedIndex;
        }
    }
}
